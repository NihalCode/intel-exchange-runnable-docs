...
export const navLinkClass =
  "rounded-[var(--radius-md)] px-2 py-1 text-xs font-medium text-[var(--text-secondary)] hover:bg-[var(--surface-muted)] hover:text-[var(--text-primary)]";

export const navLinkActiveClass =
  "rounded-[var(--radius-md)] bg-[var(--surface-muted)] px-2 py-1 text-xs font-medium text-[var(--text-link)]";

export const pageTitleClass =
  "text-2xl font-semibold tracking-tight text-[var(--text-heading)] sm:text-3xl";

export const eyebrowClass =
  "text-xs font-semibold uppercase tracking-wide text-[var(--accent-primary)]";

export const mutedTextClass = "text-sm text-[var(--text-secondary)]";
